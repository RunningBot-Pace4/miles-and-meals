# Miles & Meals V92 · Living Journey Light Design

Version `1.92.0` applies the approved Living Journey presentation across the complete product while preserving the V90–V91 data model, permissions, financial rules and offline behavior.

## What changed

- White/light app canvas with restrained blue, yellow, peach and green accents.
- Thin four-segment Living Journey Halo with Move, Plan, Spend and People modes.
...
4. Open the deployed app once online so `miles-meals-static-v92` activates.
