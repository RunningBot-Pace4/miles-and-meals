...
it("shows current pending cards without the historical green acknowledgement", () => {
  const data: any = { smartPlans: [], settledSettlements: [], pendingSettlements: [{ id: "payment", status: "SENT", fromUserId: "me", toUserId: "jy", toName: "JY", tripName: "Vietnam Trip", amount: 8.90, currency: "MYR", allocations: [] }] };
