...
Google Saved-list place matching uses Geoapify's Free plan (no credit card).
Set server-only `GEOAPIFY_API_KEY`. No Google paid lookup or fallback is used.
See `GOOGLE-PLACES-IMPORT.md` for setup and limitations.
