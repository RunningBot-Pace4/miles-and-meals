...
must(packageJson, '"version": "1.92.13"', "v79-or-newer package version missing");
must(packageJson, '"v79:check"', "v79 validator command missing");
must(worker, 'miles-meals-static-v92-13', "v79-or-newer service-worker cache bump missing");
