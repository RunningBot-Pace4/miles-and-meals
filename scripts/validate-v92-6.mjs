...
must(packageJson, '"version": "1.92.6"', "V92.6 package version missing");
...
must(worker, "miles-meals-static-v92-6", "V92.6 service-worker cache missing");

[
  "/* V92.6 · stationary four-column Halo controls",
  "grid-template-columns: repeat(4, minmax(0, 1fr)) !important;",
  ".journey-halo > .journey-mode {",
  "width: 100% !important;",
  "min-width: 0 !important;",
  "contain: layout paint;",
  ".journey-halo > .journey-mode[aria-selected=\"true\"] {",
  "box-shadow: inset 0 0 0 1px var(--v92-blue) !important;",
].forEach((marker) => must(css, marker, `V92.6 tab-row marker missing: ${marker}`));

const stationaryBlock = css.slice(css.indexOf("/* V92.6 · stationary four-column Halo controls"));
