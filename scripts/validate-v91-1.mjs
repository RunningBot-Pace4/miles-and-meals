...
must(packageJson, '"version": "1.92.1"', "V91.1-or-newer package version missing");
for (const marker of [
  '"cleanup:next"',
  '"cleanup:next-types"',
...
must(worker, "miles-meals-static-v92-1", "V91.1-or-newer service-worker cache missing");
