...
must(packageJson, '"version": "1.92.13"', "v80-or-newer package version missing");
...
must(worker, 'miles-meals-static-v92-13', "v80-or-newer service-worker cache bump missing");
