...
must(packageJson, '"version": "1.92.3"', "v80-or-newer package version missing");
...
must(worker, 'miles-meals-static-v92-3', "v80-or-newer service-worker cache bump missing");
