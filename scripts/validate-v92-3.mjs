...
must(packageJson, '"version": "1.92.16"', "V92.3-or-newer package version missing");
...
must(worker, "miles-meals-static-v92-16", "V92.3-or-newer service-worker cache missing");
