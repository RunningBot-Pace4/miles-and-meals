...
must(packageJson, '"version": "1.92.24"', "V92.3-or-newer package version missing");
...
must(worker, "miles-meals-static-v92-24", "V92.3-or-newer service-worker cache missing");
...
for (const forbidden of [
  ...
  if (links.includes(forbidden)) {
    throw new Error(`V92.3-or-newer still contains obsolete navigation: ${forbidden}`);
  }
}
must(navigationGate, "sharedLinkPath", "V92.3 shared navigation exception missing");
must(nav, "prefetch", "V92.3 main destinations are not prefetched");
