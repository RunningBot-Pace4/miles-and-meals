...
must(packageJson, '"version": "1.92.6"', "V92.4-or-newer package version missing");
...
must(worker, "miles-meals-static-v92-6", "V92.4-or-newer service-worker cache missing");
