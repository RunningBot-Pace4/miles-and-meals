...
must(packageJson, '"version": "1.92.17"', "V92.2-or-newer package version missing");
...
must(worker, 'miles-meals-static-v92-17', "V92.2-or-newer service-worker cache missing");
