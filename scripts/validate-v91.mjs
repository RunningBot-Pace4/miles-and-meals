...
must(packageJson, '"version": "1.92.27"', "V91-or-newer package version missing");
must(packageJson, '"v91:check"', "V91 validation command missing");
must(serviceWorker, "miles-meals-static-v92-27", "V91-or-newer service-worker cache was not bumped");
