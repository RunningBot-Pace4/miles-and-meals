...
must(packageJson, '"version": "1.82.2"', "v81-or-newer package version missing");
...
must(worker, 'miles-meals-static-v82-2', "v81-or-newer service-worker cache bump missing");
