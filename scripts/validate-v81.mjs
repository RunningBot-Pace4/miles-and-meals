...
must(packageJson, '"version": "1.91.1"', "v81-or-newer package version missing");
...
must(worker, 'miles-meals-static-v91-1', "v81-or-newer service-worker cache bump missing");
