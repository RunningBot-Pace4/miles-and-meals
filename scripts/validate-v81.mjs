...
must(packageJson, '"version": "1.92.24"', "v81-or-newer package version missing");
...
must(worker, 'miles-meals-static-v92-24', "v81-or-newer service-worker cache bump missing");
