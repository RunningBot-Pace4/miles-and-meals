...
must(packageJson, '"version": "1.92.21"', "v81-or-newer package version missing");
...
must(worker, 'miles-meals-static-v92-21', "v81-or-newer service-worker cache bump missing");
