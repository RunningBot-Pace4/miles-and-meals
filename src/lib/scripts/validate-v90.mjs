...
must(packageJson, '"version": "1.92.26"', "V90-or-newer package version missing");
must(packageJson, '"v90:check"', "V90 validator command missing");
must(read("public/sw.js"), "miles-meals-static-v92-26", "V90-or-newer service-worker cache was not bumped");
