...
export const countryCatalog: CountryCatalogItem[] = [
  ...
  { name: "Bonaire, Sint Eustatius and Saba", code: "BQ", currencyCode: "USD" },
  ...
  { name: "Curaçao", code: "CW", currencyCode: "XCG" },
  { name: "Cyprus", code: "CY", currencyCode: "EUR" },
  { name: "Czechia", code: "CZ", currencyCode: "CZK" },
  { name: "Côte d'Ivoire", code: "CI", currencyCode: "XOF" },
  { name: "Democratic Republic of the Congo", code: "CD", currencyCode: "CDF" },
  ...
  { name: "Lesotho", code: "LS", currencyCode: "ZAR" },
  ...
  { name: "Namibia", code: "NA", currencyCode: "ZAR" },
  ...
  { name: "Palestine", code: "PS", currencyCode: "ILS" },
  ...
  { name: "Republic of the Congo", code: "CG", currencyCode: "XAF" },
  { name: "Romania", code: "RO", currencyCode: "RON" },
  { name: "Russia", code: "RU", currencyCode: "RUB" },
  { name: "Rwanda", code: "RW", currencyCode: "RWF" },
  { name: "Réunion", code: "RE", currencyCode: "EUR" },
  { name: "Saint Barthélemy", code: "BL", currencyCode: "EUR" },
  { name: "Saint Helena, Ascension and Tristan da Cunha", code: "SH", currencyCode: "SHP" },
  { name: "Saint Kitts and Nevis", code: "KN", currencyCode: "XCD" },
  { name: "Saint Lucia", code: "LC", currencyCode: "XCD" },
  { name: "Saint Martin (French part)", code: "MF", currencyCode: "EUR" },
  ...
  { name: "Sierra Leone", code: "SL", currencyCode: "SLE" },
  { name: "Singapore", code: "SG", currencyCode: "SGD" },
  { name: "Sint Maarten (Dutch part)", code: "SX", currencyCode: "XCG" },
  ...
  { name: "Türkiye", code: "TR", currencyCode: "TRY" },
...
const countryByCode = new Map(
  countryCatalog.map((country) => [country.code, country]),
);

export function getCountryCatalogItem(
  code: string,
): CountryCatalogItem | null {
  return countryByCode.get(code.trim().toUpperCase()) ?? null;
}
