...
export default function TermsPage() {
  return <main className="legal-page">
    ...
    <section><h2>Google Maps features</h2><p>Place matching and distance sorting use Google Maps Platform. Use of these features is also subject to the <a href="https://cloud.google.com/maps-platform/terms" target="_blank" rel="noreferrer">Google Maps Platform Terms of Service</a> and the <a href="https://policies.google.com/terms" target="_blank" rel="noreferrer">Google Terms of Service</a>. Google Maps search results may change and can occasionally match the wrong branch or similarly named place; users must review flagged matches before saving.</p></section>
