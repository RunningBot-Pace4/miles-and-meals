  ...
  return (
    <div className="stack gap-lg trip-inbox-workspace">
      ...
      <section className="panel trip-inbox-import">
        ...
        <label>Or paste booking/email text<textarea rows={7} value={text} onChange={(event) => { setText(event.target.value); setSourceType("PASTE"); }} placeholder="Paste flight, hotel, train or ticket confirmation here…" /></label>
